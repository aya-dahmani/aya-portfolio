      ...
      <div className="project-list">
        ...
        <article className="project-row" title="Petal & Stem">
          ...
          <div>
            ...
            <div className="project-links">
              <a href="https://github.com/aya-dahmani/myflower-shop.git" className="project-link-btn" target="_blank" rel="noopener noreferrer">
                <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true">
                  <path d="M3 6h18v12H3z" />
                  <path d="m7 10 2 2-2 2" />
                  <path d="M12 14h5" />
              ...
              <a href="https://myflower-shop-8ron.vercel.app/" className="project-link-btn" target="_blank" rel="noopener noreferrer">
                <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true">
                  <path d="M14 3h7v7" />
                  <path d="M10 14 21 3" />
                  <path d="M21 14v7h-7" />
        ...
        <article className="project-row" title="Restaurant Menu">
          <span className="project-tag">PERSONAL PROJECT</span>
          <div>
            <h3>Restaurant Menu</h3>
            <p>
              A restaurant menu web site— browse dishes, categories, and details
              in a clean, appetite-friendly layout.
            </p>
            <div className="project-links">
              <a href="https://github.com/aya-dahmani/menu-.git" className="project-link-btn" target="_blank" rel="noopener noreferrer">
                <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true">
                  <path d="M3 6h18v12H3z" />
                  <path d="m7 10 2 2-2 2" />
                  <path d="M12 14h5" />
              ...
              <a href="https://menu-aya27.vercel.app/" className="project-link-btn" target="_blank" rel="noopener noreferrer">
                <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true">
                  <path d="M14 3h7v7" />
                  <path d="M10 14 21 3" />
                  <path d="M21 14v7h-7" />
